<template>
  ...
  -->
  <div
    class="bootloader-container"
    role="region"
    aria-label="Android Bootloader Terminal"
    ref="bootloaderContainer"
  >
    <pre class="bootlog" role="log" aria-live="polite" aria-label="Bootloader output">{{
      bootlogContent
    }}</pre>
  </div>
</template>
...
const bootData = [
  ...
  {
    timestamp: '00:00:00.023',
    hex: '0x001020',
    msg: 'Product/Variant: jonellwood_dev',
    status: '',
  },
  ...
  {
    timestamp: '00:00:00.212',
    hex: '0x001130',
    msg: '├─ git-changelog-manager v1.0.3',
    status: '',
  },
  ...
  { timestamp: '00:00:00.295', hex: '0x0011B0', msg: '├─ PHP Backend [OK]', status: '✓' },
  {
    timestamp: '00:00:00.312',
    hex: '0x0011C0',
    msg: '├─ SQL Server & mySQL Database [OK]',
    status: '✓',
  },
  ...
  {
    timestamp: '00:00:00.434',
    hex: '0x001270',
    msg: '├─ GitHub: github.com/jonellwood',
    status: '',
  },
  {
    timestamp: '00:00:00.445',
    hex: '0x001280',
    msg: '├─ LinkedIn: /in/jon-ellwood...',
    status: '',
  },
  ...
  {
    timestamp: '00:00:00.495',
    hex: '0x0012D0',
    msg: 'DEVICE STATE: Engaged in government work',
    status: '',
  },
  {
    timestamp: '00:00:00.512',
    hex: '0x0012E0',
    msg: 'UNLOCK STATUS: Available for consult',
    status: '',
  },
  { timestamp: '00:00:00.523', hex: '0x0012F0', msg: '', status: '' },
  {
    timestamp: '00:00:00.534',
    hex: '0x001300',
    msg: '───────────────────────────────────',
    status: '',
  },
  ...
  {
    timestamp: '00:00:00.556',
    hex: '0x001320',
    msg: "EASTER EGG: Type 'woodwork' for",
    status: '',
  },
